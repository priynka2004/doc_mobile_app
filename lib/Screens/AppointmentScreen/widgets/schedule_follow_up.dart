                  ...
                  children: [
                     Text(
                      ...
                      style: GoogleFonts.urbanist(
                        textStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600,color: Color(0xff0C091F)),
                    ),
                    ),
            ...
            Row(
              ...
              children: [
                 Text(
                  'Time',
                  style: GoogleFonts.roboto(
                    textStyle: const TextStyle(fontWeight: FontWeight.w500, fontSize: 16,color: Color(0xff0C091F)),
                ),),
                Container(
                  width: 160,
                  height: 52,
