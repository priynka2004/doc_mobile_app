...
//   const FeverAffirmationsSheet({Key? key}) : super(key: key);
//
//   @override
...
class FeverAffirmationsSheet extends StatefulWidget {
  const FeverAffirmationsSheet({this.symptomName, Key? key}) : super(key: key);
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextButton(
                                ...
                                onPressed: () {
                                  String timePeriod = timePeriodController.text.isEmpty ? '2' : timePeriodController.text;
                                  String duration = selectedValue ?? 'years';
